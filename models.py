...
class Document(db.Model):
    ...
    front_file_path = db.Column(db.String(255), nullable=False)
    back_file_path = db.Column(db.String(255))  # Opcional para passaporte
    file_path = db.Column(db.String(255))  # Campo mantido para compatibilidade com código existente
